...
const embed2 = new EmbedBuilder()
  .setColor('#0099ff')
  .setDescription('Volunteers, Moderators, and Leads reserve the right to take actions based on their judgment, even if those actions aren\'t explicitly mentioned above. If you have concerns regarding any action taken, please feel free to contact the server admin by sending a direct message to @InAppChat.')
  .setFooter({ text: 'InAppChat', iconURL: 'https://i.imgur.com/yPTgIKp.png' });
...
const embed3 = new EmbedBuilder()
  ...
  .setFooter({ text: 'InAppChat', iconURL: 'https://i.imgur.com/yPTgIKp.png' });
    const rulesChannel = this.client.channels.cache.get('1096238795910811648'); // replace with the channel ID of your #rules channel
